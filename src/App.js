...
function App() {
        ...
        fetch("http://localhost:8080/predict", {
            ...
            body: JSON.stringify({
                "programming_languages": {
                    ...
                    "android": isInValues("skills", "programming_languages", "android"),
                    "ios": isInValues("skills", "programming_languages", "ios"),
                    ...
                    "scala": isInValues("skills", "programming_languages", "scalat")
                },
                "backend_frameworks": {
                    ...
                    "express": isInValues("skills", "backend_frameworks", "expresst")
                },
                "devops": {
                    ...
                    "cloud": isInValues("skills", "devops", "cloudt")
                },
                "frontend_frameworks": {
                    ...
                    "bootstrap": isInValues("skills", "frontend_frameworks", "bootstrapt")
                },
                "system_design_skills": {
                    ...
                    "uml": isInValues("skills", "system_design_skills", "umlt")
                },
                "version_controls": {
                    "git": isInValues("skills", "version_controls", "gitt")
                },
                "ui_ux": {
                    ...
                    "ui_ux": isInValues("skills", "ui_ux", "ui_uxt")
                },
                "data_related": {
                    ...
                    "snowflake": isInValues("skills", "data_related", "snowflaket")
                },
                "databases": {
                    ...
                    "sqlite": isInValues("skills", "databases", "sqlite"),
                    ...
                    "sql": isInValues("skills", "databases", "sqlt")
                },
                "ai_modeling": {
                    ...
                    "data_preprocessing": isInValues("skills", "ai_modeling", "data_preprocessingt")
                },
                "ai_frameworks": {
                    ...
                    "seaborn": isInValues("skills", "ai_frameworks", "seabornt")
                },
                "network_skills": {
                    ...
                    "tcp_ip": isInValues("skills", "network_skills", "tcp_ipt")
                },
                "hardware_skills": {
                    ...
                    "proteus": isInValues("skills", "hardware_skills", "proteust")
                },
                "os": {
                    "linux": isInValues("skills", "os", "linux"),
                    "vmware": isInValues("skills", "os", "vmware"),
                    "windows": isInValues("skills", "os", "windowst")
                },
                "education": {
                    ...
                    "other_major": isInValues("education", null, "other_majort")
                },
                "experience": {
                    "mobile_developer": isInValues("experience", null, "mobile_developer"),
                    ...
                    "software engineer": isInValues("experience", null, "software"),
                    ...
                    "database_administrator": isInValues("experience", null, "database_administratort")
                }
            })
    ...
    return (
        <div className="App">
            <Cascader multiple options={categories} onChange={(value) => setValues(value)}/>
